...
$options[] = array(  
	...
	"desc" => "Enter tagline for Home page.",
...
$options[] = array(  
	...
	"name" => "Address of the Church.",



	"desc" => "Please enter address of the church here to show a direction button at the header of the website.",
